...
ggsave(filename = "fig2.png",
       plot = Figure2,
       path = "C:/Users/Noah/OneDrive/Desktop/Northeastern/Kimbro lab/My research/Artificial reef meta/Figures",
       dpi = 600,
       height = 8,
       width = 8)
...
Figure4A<- plot_grid(Figure4A+theme(legend.position = "none"),
                     ncol = 1)
Figure4A
...
Figure4B <- plot_grid(Figure4B + theme(legend.position = c(0.9,0.9)),
                      ncol = 1)
Figure4B

Figure4AB <-  Figure4B / Figure4A 
Figure4AB + plot_annotation(tag_levels = 'A')

ggsave(filename = "fig4.png",
       plot = Figure4AB + plot_annotation(tag_levels = 'A'),
       path = "C:/Users/Noah/OneDrive/Desktop/Northeastern/Kimbro lab/My research/Artificial reef meta/Figures",
       dpi = 600,
       height = 8.5,
       width = 8)
...
ggsave(filename = "fig5.png",
       plot = plot_grid(panel1 + theme(axis.text.x=element_blank()),
                        panel2 + theme(axis.text.x=element_blank()),
                        panel3 + theme(axis.text.x=element_blank()),
                        panel4 + theme(axis.text.x=element_blank()),
                        panel5 + theme(axis.text.x=element_blank()),
