...
Figure3 <- ggplot()+
  geom_point(data = abundanceData,
             aes(x = paste("Abundance (", length(unique(abundanceData$ID)),")", sep = ""),
  ...
  geom_point(data = biomassData,
             aes(x = paste("Biomass (", length(unique(biomassData$ID)), ")", sep = ""),
  ...
  geom_point(data = richnessData,
             aes(x = paste("Richness (", length(unique(richnessData$ID)),")", sep = ""),
  ...
  geom_text(data = abundanceData,
            ...
            label = paste("n =", length(abundanceData$abundance.CohenD)),
            size = 5)+
  geom_text(data = biomassData,
            ...
            label = paste("n =", length(biomassData$biomass.CohenD)),
            size = 5)+
  geom_text(data = richnessData,
            ...
            label = paste("n =", length(richnessData$richness.CohenD)),
            size = 5)
